export const scheduleData = {
  ...
  "7B": {
    ...
    "Thứ sáu": {
      Sáng: ["Ngữ Văn", "Khoa học Tự nhiên", "Tiếng Anh", "Toán", "Công nghệ"],
      Chiều: ["", "", ""],
    },
    "Thứ bảy": {
      Sáng: ["Lịch sử", "Giáo dục địa phương", "Toán", "Ngữ Văn", "Tiếng Anh"],
      Chiều: ["", "", ""],
    },
    "Chủ nhật": { Sáng: ["", "", "", "", ""], Chiều: ["", "", ""] },
  },
  "7C": {
    "Thứ hai": {
      Sáng: ["Ngữ Văn", "Toán", "HĐ TN, hướng nghiệp", "Lịch sử", "Tiếng Anh"],
      Chiều: ["", "", ""],
    },
    "Thứ ba": {
      Sáng: [
